...
ControlHandles.CommandEdit = uicontrol(CommandPanel, 'Style', 'edit', ...
    'FontUnits', 'normalized', 'FontSize', 0.5, ...
    'HorizontalAlignment', 'left', ...
    'Units', 'normalized', 'Position', EditPos + [TextPos(3), 0, 0, 0], ...
    'Callback', @executeCommandFromGUI);
uicontrol(CommandPanel, 'Style', 'pushbutton', ...
    'String', 'Execute command', ...
    'FontUnits', 'normalized', 'FontSize', 0.5, ...
    'Units', 'normalized', ...
    'Position', ButtonPos + [TextPos(3)+EditPos(3), 0, 0, 0], ...
    'Callback', @executeCommandFromGUI);
uicontrol(CommandPanel, 'Style', 'pushbutton', ...
    'String', 'Array programming GUI', ...
    'FontUnits', 'normalized', 'FontSize', 0.5, ...
    'Units', 'normalized', ...
    'Position', ButtonPos + [1-ButtonPos(3), 0, 0, 0], ...
    'Callback', @openArrayGUI);
...
propertiesToGUI();
    ...
    function openArrayGUI(~, ~)
        % This callback opens the trigger array GUI.
        obj.triggerArrayGUI();
    end
