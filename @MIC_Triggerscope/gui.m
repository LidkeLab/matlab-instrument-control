...
if ~(exist('GUIParent', 'var') && ~isempty(GUIParent) ...
    ...
    GUIParent = figure('MenuBar', 'none', ...
        ...
        'Units', 'pixels', ...
        'Position', DefaultFigurePosition .* [0.5, 1, 1, 1]);
end
...
ButtonPos = [0, 0, 0.5/NColumns, 0.3/NRows];
TextPos = [0, 0, 0.3/NColumns, 0.25/NRows];
EditPos = ButtonPos .* [1, 1, 0.5, 1];
...
uicontrol(TTLDACPanel, 'Style', 'text', ...
    ...
    'String', 'DAC Voltage Range:', ...
    'Units', 'normalized', 'Position', VRangeTextPos, ...
...
uicontrol(TTLDACPanel, 'Style', 'popupmenu', ...
    ...
    'Tooltip', SerialPortMessage, ...
    'Units', 'normalized', ...
    'Position', VRangeTextPos.*[1, 1, 0.5, 1] ...
    + [VRangeTextPos(3), 0, 0, 0], ...
...
for pp = 1:NTTLDACPorts
    ...
    uicontrol(TTLDACPanel, 'Style', 'edit', ...
        'FontUnits', 'normalized', 'FontSize', 0.6, 'String', '0', ...
...
uicontrol(StatusPanel, 'Style', 'edit', ...
    ...
    function toggleTTL(Source, ~, TTLNumber)
        ...
        CurrentState = strcmpi(Source.String, 'turn off');
        ...
        Source.String = ['turn ', obj.convertLogicalToStatus(...
            CurrentState, {'on', 'off'})];
