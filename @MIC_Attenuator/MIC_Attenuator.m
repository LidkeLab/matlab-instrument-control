classdef MIC_Attenuator < MIC_Abstract
    %   MIC_Attenuator Matlab Instrument Control Class..
    %   This class is written to control the Attenuator.
    %   Note that the attenuator does not block the beam completely.
    %   
    %   The laser damage threshold for this attenuator is 1 W/cm2.
    %   The operation wavelength is 420-700 nm.
    % 
    %   The current from the LED driver is regulated by the analog voltage 
    %   output (0 to 5 V) of a 
