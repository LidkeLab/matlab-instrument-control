classdef MIC_TCubePiezoM < MIC_LinearStage_Abstract
    ...
    properties
        IsMock logical = false;  % Add this property to indicate mock mode
    end
    ...
    methods
        function obj = MIC_TCubePiezoM(SerialNoTPZ001, SerialNoTSG001, AxisLabel, isMock)
            ...
            if ~obj.IsMock
                % Only execute these steps if not in mock mode
                obj.openDevices();
                obj.zeroStrainGauge();
