...
BigPanelHeight = 475; % height of big uipanels
...
for ii = 1:10
    for jj = 1:10
        ...
        uicontrol('Parent', ROISelectionPanel, 'Style', 'pushbutton', ...
            ...
            'Position', [5 + 38*(jj-1), 350 - 38*(ii-1), 38, 38], ...
            'TooltipString', ...
...
uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
    ...
    'Position', [25, MediumPanelHeight-50, 125, 15], ...
    'HorizontalAlignment', 'left');
handles.Edit647PowerFocus = uicontrol(...
    'Parent', LightSourceControlPanel, 'Style', 'Edit', ...
    'Position', [150, MediumPanelHeight-50, 35, 15], ...
    'HorizontalAlignment', 'left', ...
