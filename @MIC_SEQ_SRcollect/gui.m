...
uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
    'String', '647nm Laser', ...
    'Position', [5, MediumPanelHeight-35, 200, 15], ...
    'HorizontalAlignment', 'left');
uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
    'String', 'On during focus:', ...
...
% uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
%     'String', '405nm Laser', ...
%     'Position', [5, MediumPanelHeight-115, 200, 15], ...
%     'HorizontalAlignment', 'left');
% uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
...
%     'Position', [25, MediumPanelHeight-145, 125, 15], ...
%     'HorizontalAlignment', 'left');
% handles.Edit405PowerBleach = uicontrol(...
%     'Parent', LightSourceControlPanel, 'Style', 'Edit', ...
%     'Position', [150, MediumPanelHeight-145, 35, 15], ...
%     'HorizontalAlignment', 'left', ...
...
%     'Position', ...
%     [floor(MediumPanelWidth/2-125/2), MediumPanelHeight-170, 125, 25], ...
%     'Callback', @open405LaserGUI);
uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
    'String', 'LED Lamp', ...
    'Position', [5, MediumPanelHeight-195, 200, 15], ...
    'HorizontalAlignment', 'left');
uicontrol('Parent', LightSourceControlPanel, 'Style', 'Text', ...
    'String', 'Lamp Power (% of max):', ...
    'Position', [25, MediumPanelHeight-210, 125, 15], ...
    'HorizontalAlignment', 'left');
handles.EditLampPower = uicontrol(...
    'Parent', LightSourceControlPanel, 'Style', 'Edit', ...
    'Position', [150, MediumPanelHeight-210, 35, 15], ...
    'HorizontalAlignment', 'left', ...
...
handles.ButtonOpenLampGUI = uicontrol(...
    ...
    'Position', ...
    [floor(MediumPanelWidth/2-125/2), MediumPanelHeight-235, 125, 25], ...
