...
handles.TextNMean = uicontrol(...
    'Parent', RegistrationControlPanel, ...
    'Style', 'text', 'String', 'Number of images per z position:', ...
    'Position', [15, SmallPanelHeight-75, 200, 15], ...
    'TooltipString', ...
    'Number of brightfield images taken at each defocus position');
handles.EditboxNMean = uicontrol(...
    'Parent', RegistrationControlPanel, 'Style', 'edit', ...
    'String', obj.NMean, ...
    'Position', [200, SmallPanelHeight-75 35, 15], ...
    'Tag', 'NMean', 'Callback', @editNMean);
TopButtonPosition = ...
...
% methods that we need.
    ...
    function editNMean(Source, ~)
        % Callback for the NMean edit box.
        % This is done separately because NMean needs to be changed in the
        % AlignReg class, not just in obj.
        obj.NMean = str2double(Source.String);
        obj.AlignReg.NMean = str2double(Source.String);
    end
