...
handles.TextExposureTimeLaserFocusLow = uicontrol(...
    'Parent', SCMOSControlPanel, 'Style', 'Text', ...
    'String', 'Laser focus low power:', ...
    'Position', [25, MediumPanelHeight-85, 125, 15], ...
    'HorizontalAlignment', 'left');
handles.EditExposureTimeLaserFocusLow = uicontrol(...
    'Parent', SCMOSControlPanel, 'Style', 'Edit', ...
    'Position', [150, MediumPanelHeight-85, 35, 15], ...
    'HorizontalAlignment', 'left', ...
    'Tag', 'ExposureTimeLaserFocusLow', 'Callback', @modifyClassProperty);
handles.TextExposureTimeLaserFocusHigh = uicontrol(...
    'Parent', SCMOSControlPanel, 'Style', 'Text', ...
    'String', 'Laser focus high power:', ...
    'Position', [25, MediumPanelHeight-100, 125, 15], ...
    'HorizontalAlignment', 'left');
handles.EditExposureTimeLaserFocusHigh = uicontrol(...
    'Parent', SCMOSControlPanel, 'Style', 'Edit', ...
    'Position', [150, MediumPanelHeight-100, 35, 15], ...
    'HorizontalAlignment', 'left', ...
    'Tag', 'ExposureTimeLaserFocusHigh', 'Callback', @modifyClassProperty);
...
TopButtonPosition = ...
    [floor(MediumPanelWidth/2 - 125/2), MediumPanelHeight-160, 125, 25];
...
handles.TextNMeanInitial = uicontrol(...
    'Parent', RegistrationControlPanel, ...
    'Style', 'text', 'String', 'Images per z position (initial):', ...
    'HorizontalAlignment', 'left', ...
    'Position', [15, SmallPanelHeight-75, 200, 15], ...
    'TooltipString', ['Number of brightfield images taken at ',  ...
    'each defocus position for reference and for initial cell finding.']);
handles.EditboxNMeanInitial = uicontrol(...
    'Parent', RegistrationControlPanel, 'Style', 'edit', ...
    'String', obj.NMean, ...
    'Position', [200, SmallPanelHeight-75 35, 15], ...
    'Tag', 'NMeanInitial', 'Callback', @modifyClassProperty);
handles.TextNMean = uicontrol(...
    'Parent', RegistrationControlPanel, ...
    'Style', 'text', 'String', 'Images per z position:', ...
    'HorizontalAlignment', 'left', ...
    'Position', [15, SmallPanelHeight-90, 200, 15], ...
    'TooltipString', ['Number of brightfield images taken at ',  ...
    'each defocus position for periodic re-registration.']);
handles.EditboxNMean = uicontrol(...
    'Parent', RegistrationControlPanel, 'Style', 'edit', ...
    'String', obj.NMean, ...
    'Position', [200, SmallPanelHeight-90 35, 15], ...
    'Tag', 'NMean', 'Callback', @modifyClassProperty);
TopButtonPosition = ...
...
% methods that we need.
    ...
    function properties2gui()
        ...
        handles.EditboxNMean.String = obj.NMean;
        handles.EditboxNMeanInitial.String = obj.NMeanInitial;
        ...
        if handles.CheckboxBrightfieldReg.Value
            ...
            handles.TextBrightfieldReg.Visible = 'on';
            handles.EditboxBrightfieldReg.Visible = 'on';
        end
        ...
        handles.EditExposureTimeLaserFocusLow.String = ...
            obj.ExposureTimeLaserFocusLow;
        handles.EditExposureTimeLaserFocusHigh.String = ...
