classdef MIC_RebelStarLED < MIC_LightSource_Abstract 
    ...
    %   model 3023-D-E-700.  The power can be set between 0 and 100% as well as turned off or on. 
    %   
    %   The current from the LED driver is regulated by the analog voltage output of a 
    %   NI DAQ card. The
    %   Constructor requires the Device and Channel details.
    %
    %   The output current, and therfore the light
    %   output follows the relationship  
    ...
    %   Voltage where current begins to drop from 100%. V_off and V_100
    %   must be measured and set in the class. 
    %
    %   Link to Driver: http://www.luxeonstar.com/700ma-external-dimming-buckpuck-dc-driver-leaded
    %
    % REQUIRES: 
    %   MIC_Abstract.m
