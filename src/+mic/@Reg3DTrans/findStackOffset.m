...
Stack1Size = [size(Stack1, 1), size(Stack1, 2), size(Stack1, 3)];
Stack2Size = [size(Stack2, 1), size(Stack2, 2), size(Stack2, 3)];
...
elseif ~all(MaskSize == Params.FTSize)
...
Stack1 = Stack1 ./ sum(sum(Stack1, 1), 2);
Stack2 = Stack2 ./ sum(sum(Stack2, 1), 2);
