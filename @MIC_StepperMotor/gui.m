...
%This gui is written for the Benchtop stepper motor.
%gui has three lines of uicontrols to control X, Y and Z axes (from top to
%yhe botton). The Home button moves the stage to the origin. The jog
%buttons at each sides of the slider makes the stage to jog with the size 
